...
class QLearningAgent(ReinforcementAgent):
    ...
    def getQValue(self, state, action):
        ...
        # return Q(state,action), if no value exist, return 0.0
    ...
    def computeValueFromQValues(self, state):
        ...
        "*** YOUR CODE HERE ***"
        # util.raiseNotDefined()
        # compute max Qvalue in all actions, if there have no Qvalue that means in terminal state
    ...
    def computeActionFromQValues(self, state):
        ...
        "*** YOUR CODE HERE ***"
        # util.raiseNotDefined()
        # choose one of the best actions that have max Qvalue in all actions
    ...
    def getAction(self, state):
        ...
        "*** YOUR CODE HERE ***"
        # util.raiseNotDefined()
        # Access the optimal action with a certain probability
    ...
    def update(self, state, action, nextState, reward):
        ...
        "*** YOUR CODE HERE ***"
        # util.raiseNotDefined()
        # Follow the formula on course's slide to update Qvalue
        disc = self.discount
        alpha = self.alpha
