...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        if len(actions) == 0:
            return None
        #iterate over actions and append all the qvalues and actions to 'allAction'
        else:
            for action in actions:
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        #comupute dot product or features and weight
    ...
    def update(self, state, action, nextState, reward):
        ...
        #sum the weights to their corresponding newly scaled feature
    ...
    def final(self, state):
        ...
        if self.episodesSoFar == self.numTraining:
            # you might want to print your weight here for debugging
